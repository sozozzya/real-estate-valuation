  ...
  return (
    <div className="bg-white p-4 rounded shadow mt-6">
      ...
      <p>
        95% ДИ для β:{" "}
        <b>
          [{uncertainty.beta_ci_95.lower.toFixed(2)};{" "}
          {uncertainty.beta_ci_95.upper.toFixed(2)}]
        </b>
      </p>
      ...
      <p>
        95% ДИ для α:{" "}
        <b>
          [{uncertainty.alpha_ci_95.lower.toFixed(2)};{" "}
          {uncertainty.alpha_ci_95.upper.toFixed(2)}]
        </b>
      </p>
      ...
      <p>
        ...
        <b>
          {lambda_beta_used.toFixed(2)} / {lambda_alpha_used.toFixed(2)}
        </b>
      </p>
